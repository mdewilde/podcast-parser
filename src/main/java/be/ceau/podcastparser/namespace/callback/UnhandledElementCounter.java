...
public class UnhandledElementCounter implements NamespaceCallbackHandler {
	...
	private static final Logger logger = LoggerFactory.getLogger(UnhandledElementCounter.class);

	private final Map<EncounteredElement, LongAdder> counts = new ConcurrentHashMap<>();

	@Override
	public void registerUnhandledElement(XMLStreamReader reader, String level) {
