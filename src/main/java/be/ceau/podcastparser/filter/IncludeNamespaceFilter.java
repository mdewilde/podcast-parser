...
/**
 * {@link ElementFilter} instance that skips everything except elements in a given {@link Namespace}
 */
public final class IncludeNamespaceFilter implements ElementFilter {

	private final Namespace namespace;
	
	public IncludeNamespaceFilter(String namespaceURI) {
		this(NamespaceFactory.getInstance(namespaceURI));
	}

	public IncludeNamespaceFilter(Namespace namespace) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IncludeNamespaceFilter other = (IncludeNamespaceFilter) obj;
